...
$confirm_code = $_SESSION['searched_email']['code'];
$code_error = [];
$code_error_ar = [];
...
if (isset($_POST['send'])) {
    ...
    if ($confirm == $confirm_code) {
        $_SESSION['confirmed'];
        path('mail_page-main/confirm.php');
    } else {
        $code_error[] = "Incorrect Confirm Code";
        $code_error_ar[] = "خطأ في رمز الاستعادة";
    }
}
?>
                ...
                <div class="continar">
                    <div class="main_content">
                        ...
                        <form method="post">
                            ...
                            <div class="form-group row col-lg-12">
                                <p>لقد ارسلنا اليك كود الاستعادة</p>
                                <div>
                                    <input type="number" name="code" class="form-control" id="inputEmail3" maxlength="10" placeholder="ادخل رمز الاستعادة">
                                </div>
                            ...
                            <div class="form-group row col-lg-12">
                                <div>
                                    <button type="submit" name="send" class="btn btn-primary">استمرار</button>
                                </div>
                            </div>
