...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $delete = "DELETE FROM main_directions where id = $id";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="status d-flex  justify-content-center">
                                            <a href="/Horus/bus/updateBus.php?update= <?= $data['id'] ?>" class="edit">
                                                <i class="bi bi-pencil"></i>
                                                <!-- <span>Edit</span> -->
                                                <div class="overlay"></div>
                                            </a>
                                            <a href="/Horus/bus/listBus.php?delete=<?= $data['id'] ?>" class="delete">
